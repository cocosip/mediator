...
func TestRegisterRequestHandlerRejectsTypedNilFunctionHandler(t *testing.T) {
	m := mediator.New()
	var handler mediator.RequestHandlerFunc[createUserRequest, createUserResponse]
...
func TestSendAllowsNilInterfaceResponse(t *testing.T) {
